    ...
    <nav className="bg-white border-b border-gray-100 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            <button
              onClick={() => { window.location.pathname !== '/' ? window.location.href = '/#categorias' : document.getElementById('categorias')?.scrollIntoView({ behavior: 'smooth' }) }}
            ...
            <Link to="/como-funciona" className="text-gray-600 hover:text-primary-500 font-medium transition-colors text-sm">Cómo funciona</Link>
          </div>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-2">
          ...
          <Link to="/como-funciona" className="block text-gray-700 font-medium py-2" onClick={() => setMenuOpen(false)}>Cómo funciona</Link>
