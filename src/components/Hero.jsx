...
export default function Hero() {
  ...
  function handleSearch(e) {
    ...
    else document.getElementById('categorias')?.scrollIntoView({ behavior: 'smooth' })
  }
    ...
    <section className="bg-gradient-to-br from-primary-500 to-primary-700 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Search bar */}
          <form onSubmit={handleSearch} className="bg-white rounded-2xl p-2 flex items-center gap-2 max-w-2xl mx-auto shadow-lg">
            ...
            <button type="submit" className="btn-primary shrink-0 text-sm md:text-base">
              Buscar
            </button>
          </form>
